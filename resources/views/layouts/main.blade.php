...
<body  >
    <div id="loader-container">
        <div class="loader"><img loading="eager" src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/96/Instagram.svg/2048px-Instagram.svg.png" alt="Instagram Logo">
        </div>
    </div>
    ...
    <div class="container-fluid ">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-2 p-0 col-lg-2" style="height:100vh" >
